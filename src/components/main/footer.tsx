        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 flex flex-col md:mb-0">
            ...
            <div className="mt-6 flex justify-center gap-x-4">
              <a
                href="https://twitter.com/PremiosESLAND"
              ...
              <a
                href="https://www.instagram.com/premiosesland/"
                className="text-white hover:text-primary duration-300"
              >
                <svg
                  className="size-6"
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold uppercase text-white">
                {dictionary.FOOTER.WEB_MAP.TITLE}
              </h2>
              <ul className="flex flex-col gap-2 font-medium text-gray-400">
                <li>
                  <Link
            ...
            <div>
              <h2 className="mb-0 text-sm font-semibold uppercase text-white">
                {dictionary.FOOTER.PRODUCED_BY}
              </h2>
              <Link
                className="hover:opacity-100 opacity-70 transition-opacity duration-300 block"
